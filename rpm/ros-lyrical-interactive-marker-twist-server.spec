...
%global pkg_name interactive_marker_twist_server
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-interactive-marker-twist-server
Version:        2.1.0
Release:        4%{?dist}
...
%changelog
* Wed Apr 29 2026 Mike Purvis <mpurvis@clearpathrobotics.com> - 2.1.0-4
- Autogenerated by Bloom

* Tue Apr 28 2026 Mike Purvis <mpurvis@clearpathrobotics.com> - 2.1.0-3
- Autogenerated by Bloom

* Tue Apr 21 2026 Mike Purvis <mpurvis@clearpathrobotics.com> - 2.1.0-2
- Autogenerated by Bloom
